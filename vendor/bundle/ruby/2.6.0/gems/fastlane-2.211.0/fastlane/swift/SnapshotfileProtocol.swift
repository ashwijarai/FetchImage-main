...
public extension SnapshotfileProtocol {
    ...
    var outputDirectory: String { "screenshots" }
    var outputSimulatorLogs: Bool { false }
    var iosVersion: String? { nil }
    var skipOpenSummary: Bool { false }
    var skipHelperVersionCheck: Bool { false }
    var clearPreviousScreenshots: Bool { false }
    var reinstallApp: Bool { false }
    var eraseSimulator: Bool { false }
    var headless: Bool { true }
    var overrideStatusBar: Bool { false }
    var overrideStatusBarArguments: String? { nil }
    var localizeSimulator: Bool { false }
    var darkMode: Bool? { nil }
    var appIdentifier: String? { nil }
    var addPhotos: [String]? { nil }
    var addVideos: [String]? { nil }
    var htmlTemplate: String? { nil }
    var buildlogPath: String { "~/Library/Logs/snapshot" }
    ...
    var stopAfterFirstError: Bool { false }
    var derivedDataPath: String? { nil }
    var resultBundle: Bool { false }
    var testTargetName: String? { nil }
    var namespaceLogFiles: String? { nil }
    var concurrentSimulators: Bool { true }
    var disableSlideToType: Bool { false }
