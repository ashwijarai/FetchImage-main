...
public extension ScanfileProtocol {
    ...
    var skipDetectDevices: Bool { false }
    var ensureDevicesFound: Bool { false }
    var forceQuitSimulator: Bool { false }
    var resetSimulator: Bool { false }
    var disableSlideToType: Bool { true }
    var prelaunchSimulator: Bool? { nil }
    var reinstallApp: Bool { false }
    var appIdentifier: String? { nil }
    var onlyTesting: String? { nil }
    var skipTesting: String? { nil }
    var testplan: String? { nil }
    var onlyTestConfigurations: String? { nil }
    var skipTestConfigurations: String? { nil }
    var xctestrun: String? { nil }
    var toolchain: String? { nil }
    var clean: Bool { false }
    var codeCoverage: Bool? { nil }
    var addressSanitizer: Bool? { nil }
    var threadSanitizer: Bool? { nil }
    var openReport: Bool { false }
    var outputDirectory: String { "./test_output" }
    var outputStyle: String? { nil }
    var outputTypes: String { "html,junit" }
    var outputFiles: String? { nil }
    var buildlogPath: String { "~/Library/Logs/scan" }
    var includeSimulatorLogs: Bool { false }
    var suppressXcodeOutput: Bool? { nil }
    var xcodebuildFormatter: String { "xcbeautify" }
    var outputRemoveRetryAttempts: Bool { false }
    var disableXcpretty: Bool? { nil }
    var formatter: String? { nil }
    var xcprettyFormatter: String? { nil }
    var xcprettyArgs: String? { nil }
    var derivedDataPath: String? { nil }
    var shouldZipBuildProducts: Bool { false }
    var outputXctestrun: Bool { false }
    var resultBundle: Bool { false }
    var useClangReportName: Bool { false }
    var parallelTesting: Bool? { nil }
    var concurrentWorkers: Int? { nil }
    var maxConcurrentSimulators: Int? { nil }
    var disableConcurrentTesting: Bool { false }
    var skipBuild: Bool { false }
    var testWithoutBuilding: Bool? { nil }
    var buildForTesting: Bool? { nil }
    var sdk: String? { nil }
    var configuration: String? { nil }
    var xcargs: String? { nil }
    var xcconfig: String? { nil }
    var appName: String? { nil }
    var deploymentTargetVersion: String? { nil }
    var slackUrl: String? { nil }
    var slackChannel: String? { nil }
    var slackMessage: String? { nil }
    var slackUseWebhookConfiguredUsernameAndIcon: Bool { false }
    var slackUsername: String { "fastlane" }
    var slackIconUrl: String { "https://fastlane.tools/assets/img/fastlane_icon.png" }
    var skipSlack: Bool { false }
    var slackOnlyOnFailure: Bool { false }
    var slackDefaultPayloads: [String]? { nil }
    var destination: String? { nil }
    var catalystPlatform: String? { nil }
    var customReportFileName: String? { nil }
    var xcodebuildCommand: String { "env NSUnbufferedIO=YES xcodebuild" }
