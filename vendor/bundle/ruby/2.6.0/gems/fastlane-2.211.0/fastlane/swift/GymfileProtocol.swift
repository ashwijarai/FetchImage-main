...
public extension GymfileProtocol {
    ...
    var codesigningIdentity: String? { nil }
    var skipPackageIpa: Bool { false }
    var skipPackagePkg: Bool { false }
    var includeSymbols: Bool? { nil }
    var includeBitcode: Bool? { nil }
    var exportMethod: String? { nil }
    var exportOptions: [String: Any]? { nil }
    var exportXcargs: String? { nil }
    var skipBuildArchive: Bool? { nil }
    var skipArchive: Bool? { nil }
    var skipCodesigning: Bool? { nil }
    var catalystPlatform: String? { nil }
    var installerCertName: String? { nil }
    var buildPath: String? { nil }
    var archivePath: String? { nil }
    var derivedDataPath: String? { nil }
    var resultBundle: Bool { false }
    var resultBundlePath: String? { nil }
    var buildlogPath: String { "~/Library/Logs/gym" }
    var sdk: String? { nil }
    var toolchain: String? { nil }
    var destination: String? { nil }
    var exportTeamId: String? { nil }
    var xcargs: String? { nil }
    var xcconfig: String? { nil }
    var suppressXcodeOutput: Bool? { nil }
    var xcodebuildFormatter: String { "xcbeautify" }
    var disableXcpretty: Bool? { nil }
    var xcprettyTestFormat: Bool? { nil }
    var xcprettyFormatter: String? { nil }
    var xcprettyReportJunit: String? { nil }
    var xcprettyReportHtml: String? { nil }
    var xcprettyReportJson: String? { nil }
    var xcprettyUtf: Bool? { nil }
    var analyzeBuildTime: Bool? { nil }
    var skipProfileDetection: Bool { false }
    var xcodebuildCommand: String { "xcodebuild" }
    var clonedSourcePackagesPath: String? { nil }
    var skipPackageDependenciesResolution: Bool { false }
    var disablePackageAutomaticUpdates: Bool { false }
    var useSystemScm: Bool { false }
}
